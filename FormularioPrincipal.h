...
namespace EditorDungeon {
	...
	private:
		...
		System::Windows::Forms::ListView^ listaEntradas;
		System::Windows::Forms::ColumnHeader^ columnaIndice;
		System::Windows::Forms::ColumnHeader^ columnaTamanio;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->menuExportarEntrada = gcnew System::Windows::Forms::ToolStripMenuItem();
			this->menuImportarEntrada = gcnew System::Windows::Forms::ToolStripMenuItem();
			...
			this->menuAbrir->Click += gcnew System::EventHandler(this, &FormularioPrincipal::MenuAbrir_Click);
			...
			this->menuGuardar->Click += gcnew System::EventHandler(this, &FormularioPrincipal::MenuGuardar_Click);
			
			this->menuGuardarComo->Text = L"Guardar &como...";
			this->menuGuardarComo->Click += gcnew System::EventHandler(this, &FormularioPrincipal::MenuGuardarComo_Click);
			
			this->menuSalir->Text = L"&Salir";
			this->menuSalir->Click += gcnew System::EventHandler(this, &FormularioPrincipal::MenuSalir_Click);
			...
			this->menuArchivo->DropDownItems->Add(gcnew System::Windows::Forms::ToolStripSeparator());
			...
			this->menuExportarEntrada->Click += gcnew System::EventHandler(this, &FormularioPrincipal::MenuExportarEntrada_Click);
			
			this->menuImportarEntrada->Text = L"&Importar entrada...";
			this->menuImportarEntrada->Click += gcnew System::EventHandler(this, &FormularioPrincipal::MenuImportarEntrada_Click);
			...
			this->menuAcercaDe->Click += gcnew System::EventHandler(this, &FormularioPrincipal::MenuAcercaDe_Click);
			...
			// Lista de entradas
			this->listaEntradas = gcnew System::Windows::Forms::ListView();
			this->columnaIndice = gcnew System::Windows::Forms::ColumnHeader();
			this->columnaTamanio = gcnew System::Windows::Forms::ColumnHeader();
			this->columnaTipo = gcnew System::Windows::Forms::ColumnHeader();

			this->columnaIndice->Text = L"Índice";
			this->columnaIndice->Width = 80;
			this->columnaTamanio->Text = L"Tamaño";
			this->columnaTamanio->Width = 100;
			this->columnaTipo->Text = L"Tipo";
			this->columnaTipo->Width = 200;

			this->listaEntradas->Columns->Add(this->columnaIndice);
			this->listaEntradas->Columns->Add(this->columnaTamanio);
			this->listaEntradas->Columns->Add(this->columnaTipo);
			...
			this->listaEntradas->Dock = DockStyle::Fill;
			this->listaEntradas->SelectedIndexChanged += gcnew System::EventHandler(this, &FormularioPrincipal::ListaEntradas_SelectedIndexChanged);
			...
			this->botonExportar->Click += gcnew System::EventHandler(this, &FormularioPrincipal::BotonExportar_Click);
			...
			this->botonImportar->Click += gcnew System::EventHandler(this, &FormularioPrincipal::BotonImportar_Click);
			...
			this->botonVistaPrevia->Click += gcnew System::EventHandler(this, &FormularioPrincipal::BotonVistaPrevia_Click);
			...
			this->contenedorPrincipal->Panel1->Controls->Add(this->listaEntradas);
...
#pragma endregion
	...
	private:
		...
		System::Void MenuGuardar_Click(System::Object^ sender, System::EventArgs^ e);
		System::Void MenuGuardarComo_Click(System::Object^ sender, System::EventArgs^ e);
		System::Void MenuSalir_Click(System::Object^ sender, System::EventArgs^ e);
		System::Void MenuExportarEntrada_Click(System::Object^ sender, System::EventArgs^ e);
		System::Void MenuImportarEntrada_Click(System::Object^ sender, System::EventArgs^ e);
		System::Void MenuAcercaDe_Click(System::Object^ sender, System::EventArgs^ e);

		// Manejadores de eventos de controles
		System::Void ListaEntradas_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e);
		System::Void BotonExportar_Click(System::Object^ sender, System::EventArgs^ e);
		System::Void BotonImportar_Click(System::Object^ sender, System::EventArgs^ e);
		System::Void BotonVistaPrevia_Click(System::Object^ sender, System::EventArgs^ e);
